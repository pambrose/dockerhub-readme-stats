...
function renderStatsCard(stats, options = {}) {
  ...
  const titleSection = hide_title
    ...
    <g transform="translate(15, 20)">
      ...
      <text x="34" y="18" fill="${colors.titleColor}" font-size="16" font-weight="600" font-family="'Segoe UI', Ubuntu, 'Helvetica Neue', sans-serif">
        ${title}
      </text>
    </g>`;
